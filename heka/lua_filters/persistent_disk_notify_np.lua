...
function process_message ()
    ...
    out_message = string.format("VM's in %s are utilizing more than 85%% of their persistent disk\n <http://grafana-cfmetrics.company.com/dashboard/file/vm-level-stats-np.json|Grafana NonProd VM Stats>",env)
